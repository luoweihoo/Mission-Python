...
FRIEND1_NAME = "Eagle"
FRIEND2_NAME = "Falcon"
current_room = 31   # Starting room is '31'
...
for planetsectors in range(1, 26):  # rooms 1 to 25 are generated
    # ["Room Name", height, width, Top exit?, Right exit?] 
    GAME_MAP.append(["The dustry planet surface", 13, 13, True, True])
GAME_MAP += [
...
objects = {
    ...
    2: [images.soil, None, "It's like a desert. Or should that be desdert?"],
...
def game_loop():
    ...
    if  player_frame == 0:
        if keyboard.right:
            ...
            player_frame = 1
        elif keyboard.left:     # elif stops player making diagonal movments
            from_player_x = player_x
            from_player_y = player_y
            player_x -= 1
...
def generate_map():
    """This function makes the map for the current room, using room, scenery and prop data"""
